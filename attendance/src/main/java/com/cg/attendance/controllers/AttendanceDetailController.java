...
public class AttendanceDetailController {
	...
	public ResponseEntity<?> addNewAttendance(@Valid @RequestBody AttendanceDetail attendance, BindingResult result)
	...
	public ResponseEntity<?> updateAttendanceByStatus(@PathVariable String attendanceId,
			@RequestBody AttendanceDetail attendance) throws AttendanceIDException {
		return new ResponseEntity<AttendanceDetail>(attendanceService.updateAttendanceStatus(attendanceId, attendance),
				HttpStatus.OK);
	...
	public ResponseEntity<?> viewAttendanceById(@PathVariable String attendanceId) throws AttendanceIDException {
		return new ResponseEntity<AttendanceDetail>(attendanceService.viewAttendanceByAttendanceId(attendanceId),
				HttpStatus.OK);
	}
}
